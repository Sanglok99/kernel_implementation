...
static int __init list_module_init(void) {
	printk(KERN_INFO "Entering Mutex Module!\n");
...
static void __exit list_module_exit(void) {
	printk(KERN_INFO "Mutex linked list insert time: %ld ns, count: %d\n", insert_ns_time, insert_counter);
	printk(KERN_INFO "Mutex linked list search time: %ld ns, count: %d\n", search_ns_time, search_counter);
	printk(KERN_INFO "Mutex linked list delete time: %ld ns, count: %d\n", delete_ns_time, delete_counter);
        ...
        printk(KERN_INFO "Exiting Mutex Module!\n");
}
